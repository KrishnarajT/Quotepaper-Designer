...
ttf_museo = ImageFont.truetype('/run/media/krishnaraj/Programs/Python/Quotepaper Designer/Fonts/Museo 300.otf', 40)
...
def make_wallpapers(image_path):
    # read the image
    ...
    text = "Jane: So you play bad cop.\nHightower: I'll be me, thank you.\nJane: All right. Exactly what I said.\nHightower: Funny.\nJane: So funny."
    draw.text((begin_x, begin_y), text, '#e1ebec',
              font=ttf_museo, align='left')
    img.save("new.png")

make_wallpapers("./mentalist 5.png")